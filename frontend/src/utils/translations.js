...
export const translations = {
  en: {
    ...
    auth: {
      ...
      signInLink: 'Sign In',
      accountCreatedSuccess: 'Account registered successfully! Please sign in with your credentials.',
      errors: {
  ...
  hi: {
    ...
    auth: {
      ...
      accountCreatedSuccess: 'खाता सफलतापूर्वक बन गया है! कृपया अपने विवरण के साथ साइन इन करें।',
      errors: {
